    ...
    <div class="container-fluid p-0 h-100">
        <div class="row p-0 g-0">
                    ...
                    <div class="modal-content animate__animated animate__fadeInDown">
                        ...
                        <div class="modal-body">
                            <div class="container-fluid p-0">
                                <!-- Add -->
                                <div class="d-none" id="signalmentsPriority_add--body">
                                    @include("./include/priorityFormAdd")
                                </div>
                                <!-- Modfiy -->
                                <div class="d-none" id="signalmentsPriority_modify--body">
            ...
            <div class=" p-4 col-md-7" style="min-height: 100vh">
                <!-- Header -->
                <h3 class="fw-bold mt-6 mb-4">Priorités</h3>
                <div class="px-4">
                    ...
                    <table class="table table-responsive text-center align-middle">
                        <thead id="members--thead">
                            <tr>
                                ...
                                <th class="w-auto py-3" scope="col">POIDS</th>
                        ...
                        @foreach($priorities  as $priority)
                            <tr>
                                ...
                                <td>{{ $priority['name'] }}</td>
                                <td>{{ $priority['weight'] ?? 'Aucun poids (0)' }}</td>
