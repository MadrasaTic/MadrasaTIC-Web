<form class="row" id="modal--form" method="POST" action="/departments">
    @csrf
    <div class="mb-4 col-md-12">
        <label for="last_name" class="form-label">Nom</label>
        <div class="input-group">
            <input type="text" class="needs--validation w-100 p-3" placeholder="Nom" name="name" id="departments_name" />
    ...
    <div class="mb-4 col-md-12">
        ...
        <div class="input-group">
            <input type="text" class="needs--validation w-100 p-3" placeholder="Résponsable" name="responsable" id="departments_responsable" />
            <span class="check--container end-0 me-2 fs-4 ">
                <i
                    class="valid--icon fa-solid fa-circle-check text-success d-none animateanimated animatefadeIn animate__delay-0.5s"></i>
                <i
