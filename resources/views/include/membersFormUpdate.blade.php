<form class="row" id="modal_update--form" method="POST" action="/members/edit">
    ...
    <div class="mb-4 col-md-12">
        ...
        <div class="input-group">
            <input type="text" class="needs--validation w-100 p-3" placeholder="Nom" name="last_name" id="last_name" disabled/>
    ...
    <div class="mb-4 col-md-12">
        ...
        <div class="input-group">
            <input type="text" class="needs--validation w-100 p-3" placeholder="Prénom" name="first_name"
    ...
    <div class="mb-4 col-md-12">
        ...
        <div class="input-group">
            <input type="email" class="needs--validation w-100 p-3" placeholder="Email" name="email" id="email" disabled/>
            <span class="check--container end-0 me-2 fs-4">
                <i class="fa-solid fa-ban text-secondary animate__animated animate__fadeIn animate__delay-0.5s"></i>
            </span>
        </div>
