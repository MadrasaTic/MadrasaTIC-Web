...
@csrf
    <div class="mb-4 col-md-12">
        <div class="input-group">
            <input  type="hidden" value="" class="needs--validation w-100 p-3"  />
        </div>
        
    </div>
    <div class="mb-4 col-md-12">
        <div class="input-group">
            <input id="name" type="text" value="" class="needs--validation  w-100 p-3" placeholder="Name" disabled />
            <span class="check--container end-0 me-2 fs-4">
                <i class="fa-solid fa-ban text-secondary animate__animated animate__fadeIn animate__delay-0.5s"></i>
            </span>
        </div>
    </div>
    <div class="mb-4 col-md-12">
        <div class="input-group">
            <input name="display_name" id="display_name" type="text"  value="" class="needs--validation  w-100 p-3" placeholder="display_name" />
            <span class=" check--container end-0 me-2 fs-4 ">
                <i
    ...
    <div class="mb-4 col-md-12">
        <div class="input-group">
            <textarea name="description" id="description" class="text--area w-100 p-3" placeholder="Déscription de la permission"
