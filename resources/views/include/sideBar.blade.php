    ...
    <div id="sidebar--top" class="d-flex align-items-center justify-content-center border-danger" >
            <div class="h-auto w-100 ">
                ...
                <div class="h-auto w-100  h4 sidebar_links">
                    <span name=""><i class="fa-solid fa-bullhorn p-3 ms-3 me-1"></i>Annonce</span>
                </div>
                <div class="h-auto w-100  h4 sidebar_links">
                    <span name=""><i class="fa-solid fa-save p-3 ms-3 me-1"></i>Enregistré</span>
                </div>
                <div class="h-auto w-100  h4 sidebar_links" id="roles">
                    <span name="roles"><i class="fa-solid fa-key p-3 ms-3 me-1"></i>Roles</span>
                </div>
                <div class="h-auto w-100  h4 sidebar_links" id="permissions">
                    <span name="permissions"><i class="fa-regular fa-star p-3 ms-3 me-1"></i>Permissions</span>
                </div>
                <div class="h-auto w-100  h4 sidebar_links" id="members">
                    <span name="members"><i class="fa-solid fa-users p-3 ms-3 me-1"></i>Membres</span>
                </div>
                <div class="h-auto w-100  h4 sidebar_links" id="profile">
                    <span name="profile"><i class="fa-solid fa-user p-3 ms-3 me-1"></i>Mon Profil</span>
                </div>
            </div>
    </div>
