<form class="row" id="modal_update--form" method="POST" action="/signalmentsState">
    @csrf
    <div class="mb-4 col-md-12">
        <label for="last_name" class="form-label" hidden>ID</label>
        <div class="input-group">
            <input type="text" class="w-100 p-3" placeholder="ID" name="state--id" id="state--id" hidden/>
    ...
    <div class="mb-4 col-md-12">
        ...
        <div class="input-group">
            <input type="text" class="needs--validation w-100 p-3" placeholder="Nom" name="state_name"
                id="name" />
            <span class="check--container end-0 me-2 fs-4 ">
                <i
    ...
    <div class="mb-4 col-md-12">
        <input data-type="ignore-validation" type="color" class="form-control form-control-color" id="color" value="#563d7c"
