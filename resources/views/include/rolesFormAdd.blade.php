<form class="row" id="modal--form" action="/roles" method="POST">
    ...
    <div class="mb-4 col-md-12">
        <div class="input-group">
            <input type="text" class="modal--input w-100 p-3" placeholder="Nom/Code" name="display_name"/>
    ...
    <div class="row m-0 ">
        ...
        <div class="col-md-3 px-0 py-2 text-center">
            ...
            <label class="btn btn-outline-primary" for="btncheck1">{{ $permission['display_name'] }}</label>
        </div>
        @endforeach
    </div>
