                    ...
                    <div class="flex items-center">
                        <div class="hidden md:block">
                            <div class="flex items-baseline">
                                <a href="{{ config('laratrust.panel.go_back_route') }}" class="nav-button">← Go
                                    Back</a>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li>
                            <a href="{{ route('configure.roles-assignment.index') }}" class="nav-link">
                                Roles & Permissions Assignment
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('configure.roles.index') }}" class="nav-link">
                                Roles
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('configure.permissions.index') }}" class="nav-link">
                                Permissions
                            </a>
                        </li>
                        <li>
