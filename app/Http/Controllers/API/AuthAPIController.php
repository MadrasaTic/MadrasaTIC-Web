...
class AuthAPIController extends Controller
{
	...
	return "<script> function me(){window.location.replace('exp://'+document.getElementById('ip_address').value+':19000/--/user_token/".$token."');}</script>ip address<input id='ip_address' type='text'><button onclick='me()'>redirect</button>";
        //return redirect()->to('exp://192.168.1.6:19000/--/user_token/'.$token);
    }
